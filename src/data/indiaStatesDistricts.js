export const indiaStatesDistricts = {
  "Andhra Pradesh": [
    ...
    "Nellore", "Prakasam", "Srikakulam", "Sri Sathya Sai", "Visakhapatnam",
  ...
  "Arunachal Pradesh": [
    ...
    "Namsai", "Pakke Kessang", "Papum Pare", "Shi Yomi", "Tawang",
  ...
  "Manipur": [
    ...
    "Senapaty", "Tamenglong", "Tengnoupal", "Thoubal", "Ukhrul"
  ],
  "Meghalaya": [
  ...
  "Odisha": [
    ...
    "Purushottampur", "Rayagada", "Sambalpur", "Subarnapur", "Sundargarh"
  ],
  "Punjab": [
  ...
  "Sikkim": [
    "Gangtok", "Gyalshing", "Mangan", "Nanchi", "Pakyong", "Soreng"
  ],
  "Tamil Nadu": [
  ...
  "Jammu and Kashmir": [
    ...
    "Poonch", "Pulwama", "Ramban", "Reasi", "Samba", "Shopian",
    "Srinagar", "Udhampur"
  ],
  "Ladakh": [
    "Kargil", "Leh"
